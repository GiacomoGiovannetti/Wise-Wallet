export const TransactionsView = () => {
  ...
  return (
    <section className='flex flex-col items-center mt-10'>
      <h3 className='text-2xl mb-4 md:text-5xl lg:text-4xl'>
        Recent transactions
      </h3>
      <div className='flex- flex-col items-center mb-8'>
        <div className='grid grid-cols-3 grid-row-2 gap-2 text-lg text-center border-b-2 border-uranianBlue-50 mb-4 md:text-3xl lg:text-2xl'>
